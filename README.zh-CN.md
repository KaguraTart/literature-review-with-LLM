...
- 候选论文发现已加入可解释排序、重复项协调、可配置的受控引用网络扩展、人工审阅备注、结构化全文筛选阶段、排除理由、高置信建议应用、审阅状态看板和 Markdown 候选审阅报告，但更完整的证据链记录流程还需要继续加强。
...
- 在当前全文筛选阶段、排除理由、审阅状态看板和可配置引用网络策略基础上，继续加强候选论文证据链记录流程。
