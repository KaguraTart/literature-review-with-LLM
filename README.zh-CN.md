...
> 当前状态：已经可以用于单篇论文阅读、摘要、图片提问、图表/截图结构化解析、多篇论文对比与 Markdown 文献矩阵报告、集合级主题聚类工作区和受控两跳引用网络扩展，但仍处于早期版本。跨集合综述和更强的跨文献分析还在计划中。
...
- 在当前候选审阅报告和文献矩阵报告之外，增加更多论文阅读报告、开题笔记、正式综述报告等导出模板。
