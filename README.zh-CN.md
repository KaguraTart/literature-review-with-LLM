...
> 当前状态：已经可以用于单篇论文阅读、摘要、图片提问、图表/截图结构化解析和多篇论文对比的一期工作流，但仍处于早期版本。聚类、批量综述和更强的跨文献分析还在计划中。
...
- 多篇论文对比目前限制在工作台上下文内，默认最多纳入 5 篇对比论文；尚未加入自动聚类和跨集合综述矩阵。
