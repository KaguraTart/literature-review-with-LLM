...
const REQUIRED_MARKERS = [
  ...
  ["content/workbench.js", "maxHops: 2", "workbench bounded two-hop citation-network expansion"],
  ["content/workbench.js", "maxNetworkRequests: 12", "workbench citation-network request cap"],
