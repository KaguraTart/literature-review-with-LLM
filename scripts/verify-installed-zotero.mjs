...
const REQUIRED_MARKERS = [
  ...
  ["content/bootstrap-settings.js", "vercel_ai_chat", "Vercel AI Gateway Chat provider detection in bootstrap settings"],
  ["content/bootstrap-settings.js", "vercel_ai_responses", "Vercel AI Gateway Responses provider detection in bootstrap settings"],
  ["content/bootstrap-settings.js", "vercel_ai_anthropic", "Vercel AI Gateway Anthropic provider detection in bootstrap settings"],
  ["content/bootstrap-settings.js", "cline_api", "Cline API provider detection in bootstrap settings"],
  ["content/bootstrap-settings.js", "litellm_proxy_chat", "LiteLLM Proxy provider detection in bootstrap settings"],
  ...
  ["content/candidate-sources.js", "expandCandidateCitationNetwork", "citation-network expansion runtime"],
  ["content/candidate-sources.js", "maxHops", "bounded multi-hop citation-network option"],
  ["content/candidate-sources.js", "maxNetworkRequests", "citation-network request cap"],
  ["content/candidate-sources.js", "nextCitationFrontier", "citation-network next-hop frontier"],
  ["content/candidate-sources.js", "networkHop", "citation-network hop metadata"],
  ["content/candidate-sources.js", "parseSemanticScholarCitationNetworkResponse", "Semantic Scholar citation-network parser"],
  ["content/candidate-sources.js", "mergeCandidateRecords", "candidate record merge runtime"],
  ["content/candidate-sources.js", "sortCandidateRecords", "candidate priority sorting runtime"],
  ["content/candidate-sources.js", "candidatePriority", "candidate priority scorer runtime"],
  ...
  ["content/preferences.js", "chooseOutputDir", "settings output directory folder picker action"],
  ["content/preferences.js", "providerCapabilityOverrideCommands", "settings provider capability override guide"],
  ...
  ["content/preferences.xhtml", "value=\"vercel_ai_chat\"", "Vercel AI Gateway Chat provider preset"],
  ["content/preferences.xhtml", "value=\"vercel_ai_responses\"", "Vercel AI Gateway Responses provider preset"],
  ["content/preferences.xhtml", "value=\"vercel_ai_anthropic\"", "Vercel AI Gateway Anthropic provider preset"],
  ["content/preferences.xhtml", "value=\"cline_api\"", "Cline API provider preset"],
  ["content/preferences.xhtml", "value=\"litellm_proxy_chat\"", "LiteLLM Proxy Chat provider preset"],
  ["content/preferences.xhtml", "value=\"litellm_proxy_responses\"", "LiteLLM Proxy Responses provider preset"],
  ["content/preferences.xhtml", "value=\"litellm_proxy_anthropic\"", "LiteLLM Proxy Anthropic provider preset"],
  ["content/preferences.xhtml", "value=\"cloudflare_ai_chat\"", "Cloudflare AI OpenAI Chat provider preset"],
  ["content/preferences.xhtml", "value=\"cloudflare_ai_responses\"", "Cloudflare AI Responses provider preset"],
  ["content/preferences.xhtml", "value=\"cloudflare_ai_anthropic\"", "Cloudflare AI Anthropic provider preset"],
  ...
  ["content/preferences.xhtml", "value=\"github_models\"", "GitHub Models provider preset"],
  ["content/preferences.xhtml", "value=\"huggingface\"", "Hugging Face provider preset"],
  ["content/preferences.xhtml", "value=\"deepinfra\"", "DeepInfra provider preset"],
  ["content/preferences.xhtml", "value=\"fireworks\"", "Fireworks AI provider preset"],
  ["content/preferences.xhtml", "value=\"cerebras\"", "Cerebras provider preset"],
  ["content/preferences.xhtml", "value=\"nvidia_nim\"", "NVIDIA NIM provider preset"],
  ["content/preferences.xhtml", "value=\"sambanova\"", "SambaNova provider preset"],
  ["content/preferences.xhtml", "value=\"sambanova_responses\"", "SambaNova Responses provider preset"],
  ["content/preferences.xhtml", "value=\"sambanova_anthropic\"", "SambaNova Anthropic provider preset"],
  ...
  ["content/preferences.xhtml", "zms-choose-outputDir-button", "output directory folder picker button"],
  ...
  ["prefs.js", "\"id\":\"vercel-ai-chat\"", "default Vercel AI Gateway Chat profile"],
  ["prefs.js", "\"id\":\"vercel-ai-responses\"", "default Vercel AI Gateway Responses profile"],
  ["prefs.js", "\"id\":\"vercel-ai-anthropic\"", "default Vercel AI Gateway Anthropic profile"],
  ["prefs.js", "\"id\":\"cline-api\"", "default Cline API profile"],
  ["prefs.js", "\"baseURL\":\"https://ai-gateway.vercel.sh/v1\"", "Vercel AI Gateway OpenAI-compatible base URL"],
  ["prefs.js", "\"baseURL\":\"https://ai-gateway.vercel.sh\"", "Vercel AI Gateway Anthropic base URL"],
  ["prefs.js", "\"baseURL\":\"https://api.cline.bot/api/v1\"", "Cline API OpenAI-compatible base URL"],
  ["prefs.js", "\"id\":\"cloudflare-ai-chat\"", "default Cloudflare AI OpenAI Chat profile"],
  ["prefs.js", "\"id\":\"cloudflare-ai-responses\"", "default Cloudflare AI Responses profile"],
  ["prefs.js", "\"id\":\"cloudflare-ai-anthropic\"", "default Cloudflare AI Anthropic profile"],
  ["prefs.js", "\"baseURL\":\"https://api.cloudflare.com/client/v4/accounts/YOUR_ACCOUNT_ID/ai/v1\"", "Cloudflare AI OpenAI-compatible base URL template"],
  ...
  ["prefs.js", "\"id\":\"github-models\"", "default GitHub Models profile"],
  ["prefs.js", "\"id\":\"huggingface\"", "default Hugging Face profile"],
  ["prefs.js", "\"id\":\"deepinfra\"", "default DeepInfra profile"],
  ["prefs.js", "\"id\":\"fireworks\"", "default Fireworks AI profile"],
  ["prefs.js", "\"id\":\"cerebras\"", "default Cerebras profile"],
  ["prefs.js", "\"id\":\"nvidia-nim\"", "default NVIDIA NIM profile"],
  ...
  ["content/workbench.js", "exportComparisonReport", "workbench comparison report export action"],
  ["content/workbench.js", "renderComparisonReportMarkdown", "comparison report Markdown renderer"],
  ["content/workbench.js", "Capability Override Check", "provider diagnostics capability override section"],
  ["content/workbench.js", "comparisonReportMarkdownPath", "comparison report Markdown path"],
  ["content/workbench.js", "templateVersion: literature-matrix-v1", "comparison report template version"],
  ["content/workbench.js", "exportReadingLog", "workbench paper reading log export action"],
  ["content/workbench.js", "renderReadingLogMarkdown", "paper reading log Markdown renderer"],
  ["content/workbench.js", "readingLogMarkdownPath", "paper reading log Markdown path"],
  ["content/workbench.js", "templateVersion: paper-reading-log-v1", "paper reading log template version"],
  ["content/workbench.js", "exportReviewDraft", "workbench review draft export action"],
  ["content/workbench.js", "renderReviewDraftMarkdown", "review draft Markdown renderer"],
  ["content/workbench.js", "reviewDraftMarkdownPath", "review draft Markdown path"],
  ["content/workbench.js", "templateVersion: formal-review-draft-v1", "review draft template version"],
  ["content/workbench.js", "searchCandidates", "workbench candidate search action"],
  ["content/workbench.js", "expandCandidateCitationNetwork", "workbench citation-network expansion action"],
  ["content/workbench.js", "citationNetworkOptionsFromDom", "workbench configurable citation-network options"],
  ["content/workbench.js", "citationNetworkPolicyDefaults", "workbench citation-network policy presets"],
  ["content/workbench.js", "applyCitationNetworkPolicyToDom", "workbench citation-network preset application"],
  ["content/workbench.js", "citationNetworkSeedsForWorkbench", "workbench citation-network seed selection"],
  ["content/workbench.js", "exportCandidateReview", "workbench candidate review export action"],
  ["content/workbench.js", "renderCandidateReviewMarkdown", "candidate review Markdown renderer"],
  ["content/workbench.js", "candidateReviewMarkdownPath", "candidate review Markdown path"],
  ["content/workbench.js", "applyCandidateRecommendations", "workbench candidate recommendation application action"],
  ["content/workbench.js", "candidateRecommendationUpdates", "workbench candidate recommendation helper"],
  ...
  ["content/workbench.js", "candidatePriorityMetaText", "workbench candidate priority metadata"],
  ["content/workbench.js", "citationNetworkMetaText", "workbench citation-network metadata"],
  ["content/workbench.js", "appendImportLedgerEntries", "workbench import ledger append"],
  ["content/workbench.xhtml", "zms-export-comparison-report", "workbench comparison report export button"],
  ["content/workbench.xhtml", "zms-export-reading-log", "workbench paper reading log export button"],
  ["content/workbench.xhtml", "zms-export-review-draft", "workbench review draft export button"],
  ["content/workbench.xhtml", "zms-expand-citation-network", "workbench citation-network button"],
  ["content/workbench.xhtml", "zms-citation-policy", "workbench citation-network policy selector"],
  ["content/workbench.xhtml", "zms-citation-direction", "workbench citation-network direction selector"],
  ["content/workbench.xhtml", "zms-citation-hops", "workbench citation-network hop control"],
  ["content/workbench.xhtml", "zms-citation-max-requests", "workbench citation-network request cap control"],
  ["content/workbench.xhtml", "zms-export-candidate-review", "workbench candidate review export button"],
  ["content/workbench.xhtml", "zms-apply-candidate-recommendations", "workbench candidate recommendation application button"],
  ...
  ["content/messages.js", "candidateReviewDone", "candidate review export status message"],
  ["content/messages.js", "comparisonReportDone", "comparison report export status message"],
  ["content/messages.js", "readingLogDone", "paper reading log export status message"],
  ["content/messages.js", "reviewDraftDone", "review draft export status message"],
  ["content/messages.js", "citationPolicy", "citation-network policy label message"],
  ["content/messages.js", "citationPolicyBroad", "citation-network broad policy message"],
