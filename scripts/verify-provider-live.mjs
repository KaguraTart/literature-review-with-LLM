...
const DEFAULT_CASES = [
  ...
  },
  {
    ...
    profile: "litellm-proxy-chat",
    protocol: "openai_chat",
    apiKeyEnv: "LITELLM_PROXY_API_KEY",
    modelEnv: "LITELLM_PROXY_MODEL",
    baseURLEnv: "LITELLM_PROXY_BASE_URL",
    headersEnv: "LITELLM_PROXY_HEADERS_JSON",
    bodyExtraEnv: "LITELLM_PROXY_BODY_EXTRA_JSON",
    requireBaseURL: true,
    allowLocalNoAuth: true
  },
  {
    id: "litellm-proxy-responses",
    label: "LiteLLM Proxy Responses",
    profile: "litellm-proxy-responses",
    protocol: "openai_responses",
    apiKeyEnv: "LITELLM_PROXY_RESPONSES_API_KEY",
    modelEnv: "LITELLM_PROXY_RESPONSES_MODEL",
    baseURLEnv: "LITELLM_PROXY_RESPONSES_BASE_URL",
    headersEnv: "LITELLM_PROXY_RESPONSES_HEADERS_JSON",
    bodyExtraEnv: "LITELLM_PROXY_RESPONSES_BODY_EXTRA_JSON",
    requireBaseURL: true,
    allowLocalNoAuth: true
  },
  {
    id: "litellm-proxy-anthropic",
    label: "LiteLLM Proxy Anthropic",
    profile: "litellm-proxy-anthropic",
    protocol: "anthropic_messages",
    apiKeyEnv: "LITELLM_PROXY_ANTHROPIC_API_KEY",
    modelEnv: "LITELLM_PROXY_ANTHROPIC_MODEL",
    baseURLEnv: "LITELLM_PROXY_ANTHROPIC_BASE_URL",
    headersEnv: "LITELLM_PROXY_ANTHROPIC_HEADERS_JSON",
    bodyExtraEnv: "LITELLM_PROXY_ANTHROPIC_BODY_EXTRA_JSON",
    requireBaseURL: true,
    allowLocalNoAuth: true
  },
  {
