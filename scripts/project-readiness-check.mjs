...
const SOURCE_MARKERS = [
  ...
  },
  {
    ...
    markers: ["runProviderLive", "providerLiveCaseCatalog", "providerLiveEnvTemplate", "--list", "--env-template", "--env-file", "envFileLoaded", "imageInput", "pdfInput", "imageCommand", "pdfCommand", "capabilitiesForCase", "capabilitiesEnvForCase", "--capabilities-json", "CAPABILITIES_JSON", "per-case capability overrides", "OPENAI_API_KEY", "OPENAI_RESPONSES_COMPATIBLE_BASE_URL", "ANTHROPIC_API_KEY", "OPENAI_COMPATIBLE_BASE_URL", "MINIMAX_API_KEY", "GEMINI_API_KEY", "AZURE_OPENAI_API_KEY", "GITHUB_MODELS_API_KEY", "FIREWORKS_API_KEY", "CEREBRAS_API_KEY", "NVIDIA_NIM_API_KEY", "SAMBANOVA_API_KEY", "SAMBANOVA_ANTHROPIC_API_KEY", "DEEPSEEK_API_KEY", "OPENROUTER_API_KEY", "GROQ_API_KEY", "ZAI_ANTHROPIC_API_KEY", "OLLAMA_BASE_URL", "LM_STUDIO_BASE_URL", "allowLocalNoAuth", "isLocalEndpoint", "failOnSkip", "verify:provider:live", "verify:provider:image:live", "verify:provider:pdf:live", "verify:provider:models:live", "runProviderModels", "unsupportedInputReason"]
  },
  {
