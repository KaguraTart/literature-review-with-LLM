...
const SOURCE_MARKERS = [
  ...
  },
  {
    ...
    markers: ["openai_responses", "anthropic_messages", "jsonModeBodyDefaults", "openAIChatTokenLimit", "openAIChatOptionalDefaults", "openAIChatStreamOptions", "providerCompatibilityFallback", "providerCompatibilityFallbackFields", "providerStructuredUnsupportedFields", "isReasoningStreamEvent"]
  },
  {
  ...
  },
  {
    ...
    markers: ["zms-providerGuide", "providerSetupGuide", "providerLiveVerifyGuide", "envTemplateCommand", "envFileCommand", "imageCommand", "pdfCommand", "providerCapabilityOverrideCommands", "CAPABILITIES_JSON", "--env-template", "--dotenv-template", "--env-file", "OPENAI_COMPATIBLE_BASE_URL", "ANTHROPIC_COMPATIBLE_BASE_URL", "not.toContain", "routed-secret", "providerGuide"]
  },
  {
  ...
  },
  {
    ...
    markers: ["runProviderLive", "providerLiveCaseCatalog", "providerLiveEnvTemplate", "providerLiveDoctor", "providerLiveCaseGroups", "formatDotenvTemplate", "formatDoctorReport", "--list", "--env-template", "--dotenv-template", "--doctor", "--env-file", "configurationReady", "generationWithEnvFile", "modelListWithEnvFile", "envFileLoaded", "imageInput", "pdfInput", "imageCommand", "pdfCommand", "capabilitiesForCase", "capabilitiesEnvForCase", "--capabilities-json", "CAPABILITIES_JSON", "per-case capability overrides", "openai-chat", "openai-responses", "anthropic-messages", "mainstream", "OPENAI_API_KEY", "OPENAI_RESPONSES_COMPATIBLE_BASE_URL", "ANTHROPIC_API_KEY", "OPENAI_COMPATIBLE_BASE_URL", "MINIMAX_API_KEY", "GEMINI_API_KEY", "AZURE_OPENAI_API_KEY", "GITHUB_MODELS_API_KEY", "FIREWORKS_API_KEY", "CEREBRAS_API_KEY", "NVIDIA_NIM_API_KEY", "SAMBANOVA_API_KEY", "SAMBANOVA_ANTHROPIC_API_KEY", "DEEPSEEK_API_KEY", "OPENROUTER_API_KEY", "GROQ_API_KEY", "ZAI_ANTHROPIC_API_KEY", "OLLAMA_BASE_URL", "LM_STUDIO_BASE_URL", "allowLocalNoAuth", "isLocalEndpoint", "failOnSkip", "verify:provider:live", "verify:provider:image:live", "verify:provider:pdf:live", "verify:provider:models:live", "runProviderModels", "unsupportedInputReason"]
  },
  {
  ...
  },
  {
    ...
    description: "Collection workspace artifacts, cross-collection synthesis index, gap board, topic clustering, synthesis claims, conflict ledger, synthesis roadmap, and summary insight extraction are wired",
    files: ["addon/bootstrap.js"],
    markers: ["writeCollectionWorkspace", "writeCrossCollectionSynthesisIndex", "cross-collection-synthesis", "crossCollectionGapEntries", "Cross-Collection Gap Board", "loadBatchSummaryInsights", "extractSummaryInsights", "renderMethodMatrix", "renderResearchGapMatrix", "renderTopicClusters", "renderSynthesisClaimsMatrix", "renderSynthesisConflictLedger", "renderSynthesisRoadmap", "renderFormalReviewReport", "formal-review-report", "synthesis-claims", "synthesis-conflicts", "synthesis-roadmap", "topicClusterEntries", "synthesisClaimEntries", "synthesisConflictEntries", "synthesisRoadmapEntries"]
  },
  {
