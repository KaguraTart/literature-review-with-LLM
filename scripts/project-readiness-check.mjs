...
const SOURCE_MARKERS = [
  ...
  },
  {
    ...
    markers: [
      ...
      "extractPdfFlateStreamReadableTexts",
      "pdfFlateStreamEntries",
      "decompressPdfFlateByteString",
