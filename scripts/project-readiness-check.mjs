...
const SOURCE_MARKERS = [
  ...
  },
  {
    ...
    markers: ["zms-providerGuide", "providerSetupGuide", "providerLiveVerifyGuide", "envTemplateCommand", "--env-template", "OPENAI_COMPATIBLE_BASE_URL", "ANTHROPIC_COMPATIBLE_BASE_URL", "not.toContain", "routed-secret", "providerGuide"]
  },
  {
  ...
  },
  {
    ...
    markers: ["runProviderLive", "providerLiveCaseCatalog", "providerLiveEnvTemplate", "--list", "--env-template", "OPENAI_API_KEY", "OPENAI_RESPONSES_COMPATIBLE_BASE_URL", "ANTHROPIC_API_KEY", "OPENAI_COMPATIBLE_BASE_URL", "MINIMAX_API_KEY", "GEMINI_API_KEY", "AZURE_OPENAI_API_KEY", "GITHUB_MODELS_API_KEY", "FIREWORKS_API_KEY", "CEREBRAS_API_KEY", "NVIDIA_NIM_API_KEY", "SAMBANOVA_API_KEY", "SAMBANOVA_ANTHROPIC_API_KEY", "DEEPSEEK_API_KEY", "OPENROUTER_API_KEY", "GROQ_API_KEY", "ZAI_ANTHROPIC_API_KEY", "allowLocalNoAuth", "isLocalEndpoint", "failOnSkip", "verify:provider:live", "verify:provider:image:live", "verify:provider:pdf:live", "verify:provider:models:live", "runProviderModels", "unsupportedInputReason"]
  },
  {
