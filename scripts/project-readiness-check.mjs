...
const SOURCE_MARKERS = [
  ...
  },
  {
    ...
    description: "Collection workspace artifacts, cross-collection synthesis index, gap board, theme merge review board, chart review triage, topic clustering, synthesis claims, conflict ledger, synthesis roadmap, review writing packs, and summary insight extraction are wired",
    files: ["addon/bootstrap.js"],
    markers: ["writeCollectionWorkspace", "writeCrossCollectionSynthesisIndex", "cross-collection-synthesis", "crossCollectionGapEntries", "Cross-Collection Gap Board", "crossCollectionThemeMergeEntries", "Theme Merge Review Board", "crossCollectionClusterCalibrationEntries", "Cluster Threshold Calibration Board", "crossCollectionChartReviewTriageEntries", "chartReviewTriage", "Cross-Collection Chart Review Triage", "renderCrossCollectionReviewPack", "Cross-Collection Review Pack", "loadBatchSummaryInsights", "extractSummaryInsights", "renderMethodMatrix", "renderResearchGapMatrix", "renderTopicClusters", "renderSynthesisClaimsMatrix", "renderSynthesisConflictLedger", "renderSynthesisRoadmap", "renderFormalReviewReport", "renderCollectionSynthesisWritingPack", "Synthesis Writing Pack", "loadCollectionChartReviewBatchIndex", "renderCollectionChartReviewBatchIndex", "chart-review-batch-index", "Cross-Report Batch Review Board", "formal-review-report", "synthesis-claims", "synthesis-conflicts", "synthesis-roadmap", "topicClusterEntries", "synthesisClaimEntries", "synthesisConflictEntries", "synthesisRoadmapEntries"]
  },
  {
