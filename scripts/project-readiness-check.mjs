...
const SOURCE_MARKERS = [
  ...
  },
  {
    ...
    markers: ["openai_responses", "anthropic_messages", "jsonModeBodyDefaults", "openAIChatTokenLimit", "openAIChatOptionalDefaults", "openAIChatStreamOptions", "providerCompatibilityFallback", "providerCompatibilityFallbackFields", "isReasoningStreamEvent"]
  },
  {
