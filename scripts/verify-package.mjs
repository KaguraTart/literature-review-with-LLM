...
const requiredMarkers = [
  ...
  [workbenchJs, "templateVersion: proposal-note-v1", "proposal note template version"],
  ...
  [workbenchJs, "templateVersion: journal-outline-v1", "journal/report outline template version"],
  ...
  [workbenchJs, "isReasoningStreamEvent", "workbench stream reasoning event guard"],
  ...
  [providerAdaptersSource, "isReasoningStreamEvent", "provider adapter stream reasoning event guard"],
