...
const requiredMarkers = [
  ...
  [bootstrap, "roadmapFinalReportActionPlanEntries", "collection final report action plan helper"],
  [bootstrap, "Final Report Action Plan", "collection final report action plan heading"],
  ...
  [bootstrap, "formalReportSectionActionPlanEntries", "collection formal report section action plan helper"],
  [bootstrap, "Section Action Plan", "collection formal report section action plan heading"],
  [bootstrap, "Required Material", "collection formal report required material label"],
  ...
  [localAgentMcpSource, "renderPdfOcrPreprocessPage", "local PDF OCR preprocessing render dispatcher"],
  [localAgentMcpSource, "writeAdaptiveThresholdPbm", "local PDF OCR adaptive threshold preprocessing"],
  [localAgentMcpSource, "parsePgm", "local PDF OCR adaptive threshold PGM reader"],
  [localAgentMcpSource, "adaptive-threshold", "local PDF OCR adaptive threshold mode"],
  ...
  [workbenchJs, "extractPdfFlateStreamReadableTexts", "candidate FlateDecode raw PDF stream extraction"],
  [workbenchJs, "decompressPdfFlateByteString", "candidate FlateDecode byte decompression"],
  [workbenchJs, "raw_pdf_byte_text_fallback", "candidate raw PDF byte quality warning"],
  [workbenchJs, "raw_pdf_flate_stream_fallback", "candidate FlateDecode stream quality warning"],
