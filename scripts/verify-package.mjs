...
const requiredMarkers = [
  ...
  [workbenchJs, "templateVersion: proposal-note-v2", "proposal note template version"],
  ...
  [workbenchJs, "templateVersion: journal-outline-v2", "journal/report outline template version"],
