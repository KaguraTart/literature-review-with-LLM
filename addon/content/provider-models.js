(function initProviderModelCatalog(root) {
  const MODEL_CATALOG = {
    minimax: [["MiniMax-M3", "MiniMax-M3"], ["MiniMax-M2.7", "MiniMax-M2.7"], ["MiniMax-M2.7-highspeed", "MiniMax-M2.7 highspeed"], ["MiniMax-M1", "MiniMax-M1"]],
    openai: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.5", "GPT-5.5"], ["gpt-5.4", "GPT-5.4"], ["gpt-5.4-nano", "GPT-5.4 nano"], ["gpt-5-mini", "GPT-5 mini"], ["gpt-4.1", "GPT-4.1"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o", "GPT-4o"], ["gpt-4o-mini", "GPT-4o mini"], ["o3", "o3"], ["o4-mini", "o4-mini"]],
    openai_compatible: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.5", "GPT-5.5"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o-mini", "GPT-4o mini"], ["deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek-chat", "DeepSeek Chat (legacy)"], ["deepseek-reasoner", "DeepSeek Reasoner (legacy)"], ["qwen-plus", "Qwen plus"], ["qwen-max", "Qwen max"]],
    openai_responses_compatible: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.5", "GPT-5.5"], ["gpt-5.4", "GPT-5.4"], ["gpt-5.4-nano", "GPT-5.4 nano"], ["gpt-4.1", "GPT-4.1"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o", "GPT-4o"]],
    anthropic: [["claude-sonnet-4-6", "Claude Sonnet 4.6"], ["claude-opus-4-8", "Claude Opus 4.8"], ["claude-opus-4-7", "Claude Opus 4.7"], ["claude-opus-4-6", "Claude Opus 4.6"], ["claude-haiku-4-5", "Claude Haiku 4.5"], ["claude-fable-5", "Claude Fable 5"]],
    anthropic_compatible: [["claude-sonnet-4-6", "Claude Sonnet 4.6"], ["claude-opus-4-8", "Claude Opus 4.8"], ["claude-opus-4-7", "Claude Opus 4.7"], ["claude-opus-4-6", "Claude Opus 4.6"], ["claude-haiku-4-5", "Claude Haiku 4.5"]],
    gemini: [["gemini-3.1-pro", "Gemini 3.1 Pro"], ["gemini-3.5-flash", "Gemini 3.5 Flash"], ["gemini-3.1-flash", "Gemini 3.1 Flash"], ["gemini-3.1-flash-lite", "Gemini 3.1 Flash Lite"], ["gemini-2.5-pro", "Gemini 2.5 Pro"], ["gemini-2.5-flash", "Gemini 2.5 Flash"], ["gemini-2.0-flash", "Gemini 2.0 Flash"]],
    azure_openai: [["gpt-5.4-mini", "GPT-5.4 mini deployment"], ["gpt-5.5", "GPT-5.5 deployment"], ["gpt-5.4", "GPT-5.4 deployment"], ["gpt-4.1", "GPT-4.1 deployment"], ["gpt-4.1-mini", "GPT-4.1 mini deployment"], ["gpt-4o", "GPT-4o deployment"]],
    vercel_ai_chat: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4.8", "Anthropic Claude Opus 4.8"], ["google/gemini-3.5-flash", "Google Gemini 3.5 Flash"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek/deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek/deepseek-chat", "DeepSeek Chat (legacy)"], ["xai/grok-3", "xAI Grok 3"]],
    vercel_ai_responses: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-5.4", "OpenAI GPT-5.4"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["openai/gpt-4.1", "OpenAI GPT-4.1"]],
    vercel_ai_anthropic: [["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4.8", "Anthropic Claude Opus 4.8"], ["anthropic/claude-opus-4.7", "Anthropic Claude Opus 4.7"], ["anthropic/claude-haiku-4.5", "Anthropic Claude Haiku 4.5"]],
    cline_api: [["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4-8", "Anthropic Claude Opus 4.8"], ["anthropic/claude-opus-4-6", "Anthropic Claude Opus 4.6"], ["anthropic/claude-haiku-4-5", "Anthropic Claude Haiku 4.5"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["google/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["google/gemini-3.5-flash", "Google Gemini 3.5 Flash"], ["openai/gpt-4o", "OpenAI GPT-4o"], ["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-4.1", "OpenAI GPT-4.1"], ["deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek/deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek/deepseek-chat", "DeepSeek Chat (legacy)"], ["deepseek/deepseek-reasoner", "DeepSeek Reasoner (legacy)"], ["qwen/qwen-max", "Qwen Max"], ["qwen/qwen-plus", "Qwen Plus"], ["qwen/qwen3-coder", "Qwen3 Coder"], ["mistralai/mistral-large-latest", "Mistral Large"], ["mistralai/codestral-latest", "Codestral"], ["moonshotai/kimi-k2", "Kimi K2"], ["z-ai/glm-4.5", "Z.AI GLM 4.5"], ["meta-llama/llama-4-maverick", "Llama 4 Maverick"], ["xai/grok-3", "xAI Grok 3"], ["minimax/MiniMax-M3", "MiniMax M3"], ["minimax/minimax-m2.5", "MiniMax M2.5"]],
    litellm_proxy_chat: [["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-haiku-4-5", "Anthropic Claude Haiku 4.5"], ["gemini/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["gemini/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek/deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek/deepseek-chat", "DeepSeek Chat (legacy)"], ["deepseek/deepseek-reasoner", "DeepSeek Reasoner (legacy)"], ["qwen/qwen-plus", "Qwen Plus"], ["qwen/qwen3-coder", "Qwen3 Coder"], ["mistralai/mistral-large-latest", "Mistral Large"], ["moonshotai/kimi-k2", "Kimi K2"], ["z-ai/glm-4.5", "Z.AI GLM 4.5"], ["meta-llama/llama-4-maverick", "Llama 4 Maverick"], ["xai/grok-3", "xAI Grok 3"], ["minimax/MiniMax-M3", "MiniMax M3"], ["ollama/llama3.2", "Ollama Llama 3.2"]],
    litellm_proxy_responses: [["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["openai/gpt-4.1", "OpenAI GPT-4.1"], ["openai/o4-mini", "OpenAI o4-mini"]],
    litellm_proxy_anthropic: [["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4-6", "Anthropic Claude Opus 4.6"], ["anthropic/claude-haiku-4-5", "Anthropic Claude Haiku 4.5"]],
    ...
    github_models: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-4.1", "OpenAI GPT-4.1"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["mistral-ai/mistral-medium-2505", "Mistral Medium"]],
    ...
    deepseek: [["deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek-chat", "DeepSeek Chat (legacy)"], ["deepseek-reasoner", "DeepSeek Reasoner (legacy)"]],
    deepseek_anthropic: [["deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek-chat", "DeepSeek Chat (legacy)"], ["deepseek-reasoner", "DeepSeek Reasoner (legacy)"]],
    zai_anthropic: [["glm-4.5", "GLM 4.5"], ["glm-4.5-air", "GLM 4.5 Air"]],
    openrouter: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4.8", "Anthropic Claude Opus 4.8"], ["anthropic/claude-haiku-4.5", "Anthropic Claude Haiku 4.5"], ["google/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek/deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek/deepseek-chat-v3", "DeepSeek Chat V3"], ["deepseek/deepseek-r1", "DeepSeek R1"], ["qwen/qwen-max", "Qwen Max"], ["qwen/qwen3-coder", "Qwen3 Coder"], ["mistralai/mistral-large", "Mistral Large"], ["mistralai/codestral-latest", "Codestral"], ["moonshotai/kimi-k2", "Kimi K2"], ["z-ai/glm-4.5", "Z.AI GLM 4.5"], ["meta-llama/llama-4-maverick", "Llama 4 Maverick"], ["x-ai/grok-3", "xAI Grok 3"], ["minimax/minimax-m2.5", "MiniMax M2.5"]],
    dashscope: [["qwen3-max", "Qwen3 Max"], ["qwen-plus", "Qwen Plus"], ["qwen-max", "Qwen Max"], ["qwen-turbo", "Qwen Turbo"], ["qwen-vl-plus", "Qwen VL Plus"]],
  ...
  function modelLooksReasoning(text) {
    return /\b(?:o3|o4|reasoner|reasoning|r1|opus|gpt-5|gpt-5\.|sonar-reasoning)\b|deepseek-v4-pro/.test(text);
  }
