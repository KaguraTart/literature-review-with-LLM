(function initProviderModelCatalog(root) {
  const MODEL_CATALOG = {
    ...
    openai: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.4", "GPT-5.4"], ["gpt-5.4-nano", "GPT-5.4 nano"], ["gpt-5-mini", "GPT-5 mini"], ["gpt-4.1", "GPT-4.1"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o", "GPT-4o"], ["gpt-4o-mini", "GPT-4o mini"], ["o3", "o3"], ["o4-mini", "o4-mini"]],
    openai_compatible: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o-mini", "GPT-4o mini"], ["deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek-chat", "DeepSeek chat"], ["qwen-plus", "Qwen plus"], ["qwen-max", "Qwen max"]],
    openai_responses_compatible: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.4", "GPT-5.4"], ["gpt-5.4-nano", "GPT-5.4 nano"], ["gpt-4.1", "GPT-4.1"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o", "GPT-4o"]],
    anthropic: [["claude-sonnet-4-6", "Claude Sonnet 4.6"], ["claude-haiku-4-5", "Claude Haiku 4.5"], ["claude-opus-4-8", "Claude Opus 4.8"], ["claude-fable-5", "Claude Fable 5"], ["claude-sonnet-4-20250514", "Claude Sonnet 4"], ["claude-3-5-sonnet-latest", "Claude 3.5 Sonnet latest"], ["claude-3-5-haiku-latest", "Claude 3.5 Haiku latest"]],
    anthropic_compatible: [["claude-sonnet-4-6", "Claude Sonnet 4.6"], ["claude-haiku-4-5", "Claude Haiku 4.5"], ["claude-opus-4-8", "Claude Opus 4.8"], ["claude-sonnet-4-20250514", "Claude Sonnet 4"], ["claude-3-5-sonnet-latest", "Claude 3.5 Sonnet latest"]],
    ...
    azure_openai: [["gpt-5.4-mini", "GPT-5.4 mini deployment"], ["gpt-5.4", "GPT-5.4 deployment"], ["gpt-4.1", "GPT-4.1 deployment"], ["gpt-4.1-mini", "GPT-4.1 mini deployment"], ["gpt-4o", "GPT-4o deployment"]],
    vercel_ai_chat: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-sonnet-4", "Anthropic Claude Sonnet 4"], ["google/gemini-3.5-flash", "Google Gemini 3.5 Flash"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"]],
    vercel_ai_responses: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.4", "OpenAI GPT-5.4"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["openai/gpt-4.1", "OpenAI GPT-4.1"]],
    vercel_ai_anthropic: [["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-sonnet-4", "Anthropic Claude Sonnet 4"], ["anthropic/claude-haiku-4.5", "Anthropic Claude Haiku 4.5"], ["anthropic/claude-3-5-haiku", "Anthropic Claude 3.5 Haiku"]],
    ...
    github_models: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-4.1", "OpenAI GPT-4.1"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["mistral-ai/mistral-medium-2505", "Mistral Medium"]],
    ...
    openrouter: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-sonnet-4", "Anthropic Claude Sonnet 4"], ["google/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["deepseek/deepseek-chat-v3", "DeepSeek Chat V3"]],
