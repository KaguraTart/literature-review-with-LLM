(function initProviderModelCatalog(root) {
  const MODEL_CATALOG = {
    ...
    openai_compatible: [["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.5", "GPT-5.5"], ["gpt-4.1-mini", "GPT-4.1 mini"], ["gpt-4o-mini", "GPT-4o mini"], ["deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek-chat", "DeepSeek chat"], ["qwen-plus", "Qwen plus"], ["qwen-max", "Qwen max"]],
    ...
    cline_api: [["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4-8", "Anthropic Claude Opus 4.8"], ["anthropic/claude-opus-4-6", "Anthropic Claude Opus 4.6"], ["anthropic/claude-haiku-4-5", "Anthropic Claude Haiku 4.5"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["google/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["google/gemini-3.5-flash", "Google Gemini 3.5 Flash"], ["openai/gpt-4o", "OpenAI GPT-4o"], ["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-4.1", "OpenAI GPT-4.1"], ["deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek/deepseek-chat", "DeepSeek Chat"], ["xai/grok-3", "xAI Grok 3"], ["minimax/MiniMax-M3", "MiniMax M3"], ["minimax/minimax-m2.5", "MiniMax M2.5"]],
    litellm_proxy_chat: [["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-haiku-4-5", "Anthropic Claude Haiku 4.5"], ["gemini/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["gemini/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["deepseek/deepseek-chat", "DeepSeek Chat"], ["deepseek/deepseek-v4-flash", "DeepSeek V4 Flash"], ["xai/grok-3", "xAI Grok 3"], ["minimax/MiniMax-M3", "MiniMax M3"], ["ollama/llama3.2", "Ollama Llama 3.2"]],
    ...
    deepseek_anthropic: [["deepseek-v4-flash", "DeepSeek V4 Flash"], ["deepseek-v4-pro", "DeepSeek V4 Pro"], ["deepseek-chat", "DeepSeek Chat"], ["deepseek-reasoner", "DeepSeek Reasoner"]],
    zai_anthropic: [["glm-4.5", "GLM 4.5"], ["glm-4.5-air", "GLM 4.5 Air"]],
    openrouter: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4.8", "Anthropic Claude Opus 4.8"], ["google/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["deepseek/deepseek-chat-v3", "DeepSeek Chat V3"], ["x-ai/grok-3", "xAI Grok 3"], ["mistralai/mistral-large", "Mistral Large"], ["qwen/qwen-max", "Qwen Max"], ["minimax/minimax-m2.5", "MiniMax M2.5"]],
