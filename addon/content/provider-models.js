(function initProviderModelCatalog(root) {
  const MODEL_CATALOG = {
    ...
    vercel_ai_chat: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4.8", "Anthropic Claude Opus 4.8"], ["google/gemini-3.5-flash", "Google Gemini 3.5 Flash"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"]],
    ...
    cline_api: [["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4-6", "Anthropic Claude Opus 4.6"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["google/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["openai/gpt-4o", "OpenAI GPT-4o"], ["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["deepseek/deepseek-chat", "DeepSeek Chat"], ["xai/grok-3", "xAI Grok 3"], ["minimax/minimax-m2.5", "MiniMax M2.5"]],
    litellm_proxy_chat: [["openai/gpt-4o-mini", "OpenAI GPT-4o mini"], ["anthropic/claude-sonnet-4-6", "Anthropic Claude Sonnet 4.6"], ["gemini/gemini-2.5-flash", "Google Gemini 2.5 Flash"], ["deepseek/deepseek-chat", "DeepSeek Chat"], ["xai/grok-3", "xAI Grok 3"], ["ollama/llama3.2", "Ollama Llama 3.2"]],
    ...
    openrouter: [["openai/gpt-5.4-mini", "OpenAI GPT-5.4 mini"], ["openai/gpt-5.5", "OpenAI GPT-5.5"], ["openai/gpt-4.1-mini", "OpenAI GPT-4.1 mini"], ["anthropic/claude-sonnet-4.6", "Anthropic Claude Sonnet 4.6"], ["anthropic/claude-opus-4.8", "Anthropic Claude Opus 4.8"], ["google/gemini-3.1-pro", "Google Gemini 3.1 Pro"], ["google/gemini-2.5-pro", "Google Gemini 2.5 Pro"], ["deepseek/deepseek-chat-v3", "DeepSeek Chat V3"]],
