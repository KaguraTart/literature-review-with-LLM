...
- Add direct chart-image data reconstruction on top of the current prompt-level visual OCR contract, editable local OCR metadata, and JSON/CSV table sidecar export for screenshots, PDF figures, tables, and experimental results.
