...
- Add automated source-to-PDF evidence extraction and richer citation-context snippets on top of the current screening stages, exclusion reasons, screening board, evidence-chain queue, source-evidence snippets, and configurable citation-network policies.
