...
- Harden PDF page extraction beyond the current Zotero page text, local `pdftotext`, and bounded OCR fallback path, especially full-document scanned OCR, missing local file paths, OCR quality review, and no-bridge raw-byte extraction.
